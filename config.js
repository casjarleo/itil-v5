...
var UI={
title:["🎓 ITIL v5 Foundation — Dashboard","🎓 ITIL v5 Foundation — Dashboard"],qs:["Preguntas","Questions"],
home:["🏠 Inicio","🏠 Home"],hist:["📊 Historial","📊 History"],info:["ℹ️ Info","ℹ️ Info"],
togLang:["🌐 EN","🌐 ES"],themeTo:[["☀️ Claro","☀️ Light"],["🌙 Oscuro","🌙 Dark"]],
simBtn:["🎯 Examen Simulado","🎯 Mock Exam"],fullBtn:["📖 Práctica Completa","📖 Full Practice"],
...
prev:["⬅ Anterior","⬅ Previous"],next:["Siguiente ➡","Next ➡"],
flag:["🚩 Marcar","🚩 Flag"],finish:["✅ Finalizar","✅ Finish"],
backHome:["🏠 Volver","🏠 Back Home"],backDom:["⬅ Volver al Inicio","⬅ Back to Home"],
...
review:["🔍 Revisar","🔍 Review"],clearHist:["🗑 Limpiar","🗑 Clear"],
histTitle:["📊 Historial","📊 History"],
pass:["✅ ¡APROBADO!","✅ PASSED!"],fail:["❌ NO APROBADO","❌ NOT PASSED"],
of:["de","of"],correct:["correctas","correct"],approval:["Aprobación","Pass mark"],
breakdown:["📊 Desglose por Dominio","📊 Domain Breakdown"],
strengths:["💪 Fortalezas","💪 Strengths"],improve:["📚 Mejorar","📚 Improve"],
reviewTitle:["🔍 Revisión","🔍 Review"],noAnswer:["⚠ Sin responder","⚠ Unanswered"],
yourAns:["Tu respuesta","Your answer"],correctAns:["Correcta","Correct"],
noHist:["No hay intentos.","No attempts yet."],
date:["Fecha","Date"],mode:["Modo","Mode"],questions:["Preguntas","Questions"],
score:["Score","Score"],status:["Estado","Status"],trend:["📈 Tendencia","📈 Trend"],
simMode:["Simulado","Mock"],fullMode:["Completo","Full"],domMode:["Dominio","Domain"],
smartMode:["Repaso","Review"],adaptMode:["Adaptativo","Adaptive"],
realLabel:["Real","Real"],
unanswered:["sin responder. ¿Finalizar?","unanswered. Finish?"],tienes:["Tienes","You have"],
min:["min","min"],deleteAll:["¿Eliminar historial?","Delete history?"],
summaryTitle:["📊 Resumen General","📊 General Summary"],
totalQs:["Total Preguntas","Total Questions"],doms:["Dominios","Domains"],
examsDone:["Exámenes Realizados","Exams Taken"],bestScore:["Mejor Score","Best Score"],
domTitle:["📚 Dominios de Estudio","📚 Study Domains"],domLabel:["Dominio","Domain"],
...
slCD:["Dominio","Domain"],slCW:["Peso","Weight"],slCQ:["Preguntas","Questions"],
slStart:["🚀 Comenzar Examen","🚀 Start Exam"],slBack:["⬅ Volver","⬅ Back"],slTotal:["TOTAL","TOTAL"],
...
mastered:["Dominadas","Mastered"],weakLabel:["Débiles","Weak"],
inProgress:["En progreso","In Progress"],unseenLabel:["Sin intentar","Unseen"],
